...
// Copia este archivo a cotizador-danos-web/src/__tests__/<Component>.test.jsx
...
vi.mock('../context/useDemoSession', () => ({
  useDemoSession: () => ({ session: { userName: 'demo-user' }, ready: true }),
}));
