...
- [ ] Contrato API explícito si aplica (método, ruta `/v1/...`, request, response, códigos HTTP)
- [ ] Alineada con arquitectura y stack del proyecto (Spring Boot + PostgreSQL + React + mock core)
...
- Si el requerimiento es amplio, proponer un corte por capabilities antes de generar múltiples specs.
